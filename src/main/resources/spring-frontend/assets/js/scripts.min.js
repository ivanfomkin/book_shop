            ...
            return {
                init: function () {
                    $('#btn_order').on('click', function (e) {
                        Login().postData('/order', null, function (result) {
                            if (result.result) {
            ...
            return {
                init: function () {
                    ...
                    $('[data-likeid]').on('click', function (e) {
                        ...
                        Login().postData('/api/books/rateBookReview', data, function (result) {
                ...
                init: function () {
                    ...
                    $('#submitPhone').on('click', function () {
                        ...
                        postData('/requestContactConfirmation', data, function (result) {
                            if (result.result) {
                                $this.after('<div class="form-info">Вам поступит звонок с номера. Введите последние 4 цифры номера входящего звонка</div>')
                ...
                init: function () {
                    ...
                    $btnSend.on('click', function (e) {
                        ...
                        if ($this.data('sendstatus') === 'ARCHIVED' && $this.data('check')) {
                            ...
                            Login().postData('/api/cart/changeBookStatus', {
                                booksIds: $this.data('bookid'),
                                status: status
                            }, function (result) {
                                if (result.result) {
                                    ...
                                    if ($(slick.$slider).data('load')) {
                                        ...
                                        switch ($(slick.$slider).data('load')) {
                                            ...
                                            case'recent':
                                                ...
                                                break;
                                            case'author':
                                                sendData('/api/books/author/' + $(slick.$slider).data('value'))
                                                break;
                                            case'popular':
